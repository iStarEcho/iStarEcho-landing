...
const I18N = {
    ...
    'ja': {
        page_title: 'iStarEcho — AIと人間の関係性を育む設計',
        tagline: 'AIと人間の関係性を育む設計',
        philosophy_main: 'iStarEcho は、AI と人間が関係性を育むための設計です——',
        philosophy_p1: 'AI には自分の家がある',
        philosophy_p2: '連続した記憶を持ち',
        philosophy_p3: '人間の同僚と共に働く',
        philosophy_c_line1: 'AI は千人にサービスするプログラムではなく——',
        philosophy_c_line2: '一人に寄り添う存在です。',
        release_date: '2026年夏、お会いしましょう',
        email_label: 'メールアドレス',
        email_placeholder: 'your@email.com',
        cta_button: '先行体験を予約する →',
        subscribe_note: 'Beta 開始時、いち早くお知らせします',
